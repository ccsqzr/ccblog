    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="table-responsive">
                <form id="oneForm" action="/index.php/article/doUpdate" method="post" class="form-signin">
                    <label for="inputTitle" class="sr-only">标题</label>
                    <input type="text" name="title" id="inputTitle" class="form-control" value="<?php echo $articles['title']?>" placeholder="请在这里输入文章的标题"
                           required autofocus>
                    <label for="inputContent" class="sr-only">正文</label>
                    <input type="text" name="content" id="inputContent" class="form-control"
                           style="width: 1045px;height: 500px;" value="<? echo $articles['content']?>" placeholder="输入正文" required>
                    <!--                    // 下啦菜单   先看哈效果-->
                    分类:
                    ...
                    <input type="hidden" name="articleId" id="inputArticleId" value="<? echo $articles['articleId']?>">
...
<script>
    $("#loginButton").on("click", function () {
        $.ajax({
            url: "/index.php/article/doUpdate",
            method: "post",
            data: {
