        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="table-responsive">
                <form id="oneForm" action="/index.php/article/doAdd" method="post" class="form-signin">
                    ...
                    <input type="text" name="title" id="inputCategory" class="form-control" placeholder="请在这里输入新的类别"
                           required autofocus>
                    <button id="addButton" class="btn btn-lg btn-primary btn-block" type="button">新增</button>
                </form>
            </div>
        </div>
    </div>
